		...
		<ul class="sidebar-elements">
			...
			<li class="parent"><a href="#"><i
				...
				<ul class="sub-menu">
					...
					<li><a href="/uss/ion/bnr/selectBannerList.do">메인 배너 관리</a></li>
					<li><a href="/uss/ion/bnr/selectMiddleBannerList.do">중앙 배너 관리</a></li>
			...
			<!--
			<li class="parent"><a href="#"><i class="far fa-chart-bar snb-icon"></i><span>통계/리포팅</span></a>
				<ul class="sub-menu">
