...
.btn input.s_submit:first-child {
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a style="background:#75c4e6!important;" href="#LINK" onclick="fncInsertBndtCeckManage(); return false;"><spring:message code="button.save" /></a></span>
