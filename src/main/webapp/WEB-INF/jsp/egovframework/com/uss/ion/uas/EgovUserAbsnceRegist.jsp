...
<form:form commandName="userAbsnce" action="${pageContext.request.contextPath}/uss/ion/uas/addUserAbsnce.do' />" method="post"> 
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <input name="userId" id="userId" title="<spring:message code="ussIonUas.userAbsnceRegist.userId"/>" type="text" value="<c:out value='${userAbsnce.userId}'/>" class="readOnlyClass" readonly="readonly"/>
			</td>
		</tr>
		<tr>
			<th><spring:message code="ussIonUas.userAbsnceRegist.userNm"/> <span class="pilsu">*</span></th><!-- 사용자명 -->
			<td class="left">
			    <input name="userNm" id="userNm" title="<spring:message code="ussIonUas.userAbsnceRegist.userNm"/>" type="text" value="<c:out value='${userAbsnce.userNm}'/>" class="readOnlyClass" readonly="readonly"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="left">
			    <input name="lastUpdusrPnttm" id="lastUpdusrPnttm" title="<spring:message code="ussIonUas.userAbsnceRegist.lastUpdusrPnttm"/>" type="text" maxLength="50" class="readOnlyClass" readonly="readonly"/>
			</td>
		</tr> 
	</table>
