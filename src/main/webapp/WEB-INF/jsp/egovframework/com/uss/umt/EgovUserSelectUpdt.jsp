...
<style>
div.btn { margin-left: 26% !important;}
</style>
</head>
<body>
...
<div class="wTableFrm">
	<!-- ìì¸ì ë³´ ì¬ì©ì ì­ì ì prameter ì ë¬ì© input -->
	...
	<!-- ì¬ì©ìì íì ë³´ : password ìì íë©´ì¼ë¡ ì´ëì íê² ì íì ë³´ íì¸ì©, ë§ì½ê²ìì¡°ê±´ì¼ë¡ ì íì´ í¬í¨ë ê²½ì° í¼ëì í¼íê¸°ìí´ userTyëªì¹­ì ì°ì§ ìì-->
	...
	<tbody>
		...
		<tr>
			...
			<c:if test="${userManageVO.lockAt == null || userManageVO.lockAt eq '' || userManageVO.lockAt eq 'N'}">아니요</c:if>
			</td>
		</tr>
	...
	<div class="btn">
		...
		<button class="btn_s2"  style="margin-left: 10px !important;"onClick="fnDeleteUser('<c:out value='${mberManageVO.userTy}'/>:<c:out value='${mberManageVO.uniqId}'/>'); return false;" title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></button>
		...
		<button class="btn_s2 gray" onClick="document.userManageVO.reset(); return false;" title="<spring:message code="button.reset" /> <spring:message code="input.button" />"><spring:message code="button.reset" /></button>
