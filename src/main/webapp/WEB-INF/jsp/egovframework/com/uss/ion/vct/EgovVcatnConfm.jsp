...
<div class="wTableFrm">
	...
	<div style="visibility:visible;display:none;"><input name="iptSubmit" type="submit" value="<spring:message code="comUssIonVct.vcatnConfm.submit"/>" title="<spring:message code="comUssIonVct.vcatnConfm.submit"/>"></div><!-- 전송 -->
