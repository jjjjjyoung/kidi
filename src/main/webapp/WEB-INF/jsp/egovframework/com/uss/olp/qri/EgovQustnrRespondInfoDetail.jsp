...
<form name="QustnrRespondInfoForm" id="QustnrRespondInfoForm" action="<c:url value='/uss/olp/qri/EgovQustnrRespondInfoModify.do'/>" method="post">
	...
	<div style="visibility:visible;display:none;"><input name="iptSubmit" type="submit" value="<spring:message code='comUssOlpQri.title.submit' />" title="<spring:message code='comUssOlpQri.title.submit' />"></div><!--  value="전송" title="전송" -->	
