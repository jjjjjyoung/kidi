...
<form name="QustnrTmplatManageForm" id="QustnrTmplatManageForm" action="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageModify.do'/>" method="post">
	...
	<div style="visibility:visible;display:none;"><input name="iptSubmit" type="submit" value="<spring:message code='comUssOlpQtm.title.submit'/>" title="<spring:message code='comUssOlpQtm.title.submit'/>"></div><!-- value="전송" title="전송" -->	
