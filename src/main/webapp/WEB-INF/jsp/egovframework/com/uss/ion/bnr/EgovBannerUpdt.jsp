...
<input type="hidden" name="bannerTarget" value="<c:out value='${banner.bannerTarget}'/>" />
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <input name="bannerNm" id="bannerNm" title="<spring:message code="ussIonBnr.bannerUpdt.bannerNm"/>" type="text" value="<c:out value='${banner.bannerNm}'/>" maxLength="30" style="width:188px" />&nbsp;<form:errors path="bannerNm" />
			</td>
		</tr>
		<!-- 배너타겟 -->
		<!--
		<tr>
			<th><spring:message code="ussIonBnr.bannerUpdt.bannerTarget"/> <span class="pilsu">*</span></th>
			<td class="left">
		...
		<c:if test="${banner.bannerTarget == 'middle' }">
			<tr>
				<th><spring:message code="ussIonBnr.bannerUpdt.bannerTitle"/> <span class="pilsu">*</span></th><!-- 배너 제목 -->
				<td class="left">
					<input id="bannerTitle" type="text" name="bannerTitle" value="<c:out value='${banner.bannerTitle}'/>" title="<spring:message code="ussIonBnr.bannerUpdt.bannerTitle"/>" maxLength="100" />
				</td>
			</tr>
			<tr>
				<th><spring:message code="ussIonBnr.bannerUpdt.bannerSubTitle"/> <span class="pilsu">*</span></th><!-- 배너 부제목 -->
				<td class="left">
					<input id="bannerSubTitle" type="text" name="bannerSubTitle" value="<c:out value='${banner.bannerSubTitle}'/>" title="<spring:message code="ussIonBnr.bannerUpdt.bannerSubTitle"/>" maxLength="100" />
				</td>
			</tr>
		</c:if>
		<tr>
