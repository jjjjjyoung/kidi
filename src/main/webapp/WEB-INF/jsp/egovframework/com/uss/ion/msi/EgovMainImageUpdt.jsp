...
<input type="hidden" name="posblAtchFileNumber" value="1" >
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				</div><input name="mainImage" id="mainImage" type="text" title="<spring:message code="uss.ion.msi.mainImageUpdt.mainImage" />" value="<c:out value="${mainImage.image}"/>" maxLength="30" readonly="readonly" /><!-- 이미지 -->
			</td>
		</tr>
		<tr>
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<input style="background:#75c4e6!important;" class="s_submit" type="submit" value='<spring:message code="button.save" />' onclick="fncMainImageUpdate(); return false;" />
		<span class="btn_s"><a style="background:#efb98d!important;" href="<c:url value='/uss/ion/msi/removeMainImage.do'/>?imageId=<c:out value='${mainImageVO.imageId}'/>" onclick="fncMainImageDelete(); return false;"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a style="background:#6bc3b0!important;" href="<c:url value='/uss/ion/msi/selectMainImageList.do'/>?pageIndex=<c:out value='${mainImageVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${mainImageVO.searchKeyword}"/>&amp;searchCondition=1" onclick="fncSelectMainImageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
