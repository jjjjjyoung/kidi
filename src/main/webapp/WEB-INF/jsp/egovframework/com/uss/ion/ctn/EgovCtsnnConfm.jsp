...
<div class="wTableFrm">
	...
	<div style="visibility:visible;display:none;"><input name="iptSubmit" type="submit" value="<spring:message code="comUssIonCtn.ctsnnConfm.submit"/>" title="<spring:message code="comUssIonCtn.ctsnnConfm.submit"/>"></div><!-- 전송 -->
