		...
		<ul>
			<li>
				...
				<input type="hidden" name="cal_url" value="<c:url value='/sym/cal/EgovNormalCalPopup.do'/>" />
                  ...
                  <input type="text" name="tDate" size="11" readonly="readonly" tabindex="2" title="<spring:message code="comStsSst.scrinStats.toDate" />" id="tDate" value="${statsInfo.toDate}" style="margin-left: 10px;"/> <!-- 종료일자 -->
				...
				<input class="s_btn" type="submit" value="검색" title="검색" onclick="fnSearch(); return false;">
