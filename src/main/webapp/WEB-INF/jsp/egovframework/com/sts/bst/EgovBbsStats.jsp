...
<div class="board">
	...
	<div id="tab1" class="card" style="display:none;">
		<h3 class="tit02 card-header" style="margin:0 0 10px 0"><spring:message code="comStsBst.bbsStats.tab1" /> <spring:message code="comStsBst.bbsStats.statResult" /></h3>  <!-- 생성글수 통계 결과 -->
		<h4><spring:message code="comStsBst.bbsStats.tab1.subTitle1" /></h4> <!-- 그래프 (단위, 개) -->

		<!-- 막대그래프 시작 -->
		<table class="e001 mb10 card-body">
		<colgroup>
			<col style="width:14%" />
			<col style="" />
		</colgroup>
	...
	<div id="tab4" style="display:none;">
		...
		<table class="datatables-demo table table-striped table-bordered dataTable no-footer" summary="">
		<caption></caption>
		<colgroup>
			<col style="width:10%" />
			<col style="width:10%" />
