	        ...
	        <div class="con01">
	            <div class="inner">
	            	<div class="leftMenu2">
	                    <strong>JOIN</strong>
	                    <ul>
	                        <li class="on"><a href="/uat/uia/egovLoginUsr.do">Login</a></li>
		                        ...
		                        <fieldset class="login_form">
		                            ...
		                            <div class="id_area input_area">
		                                <div class="input_row" id="id_area">
		                                    <span class="input_box">
		                                        <label for="id" id="label_id_area" class="sound_only">ID</label>
		                                        <input type="text" id="id" name="id" placeholder="ID" class="int">
		                                    </span>
		                                </div>
		                            </div>
		                            <div class="pw_area input_area">
		                                <div class="input_row" id="pw_area">
		                                    <span class="input_box">
		                                        <label for="password" id="label_pw_area" class="sound_only">Password</label>
		                                        <input type="password" id="password" name="password" placeholder="Password" class="int" onkeyup="enterkey();">
		                                    </span>
		                                </div>
		                            </div>
		
		                            <input type="button" title="Login" alt="Login" value="Login" class="login_btn" onclick="actionLogin()">
		                        </fieldset>
		                    </form>
		                    <div class="forget_msg">
		                    	<!-- a href="#" onclick="goRegiUsr(); return false;"></a-->
