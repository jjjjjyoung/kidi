...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<input type="submit" class="s_submit" value="<spring:message code="button.save"/>" title="<spring:message code="button.save" /> <spring:message code="button.save" />" style="margin-left: 5px;" />
