...
<input name="chkURL" type="hidden" />
	    ...
	    <div class="hdInner">
	        <div id="use_descri">
	            <ul>
	                ...
	                <li><a href="javascript:actionLogout()"><img style="margin-top:0;" src="<c:url value='/images/egovframework/com/cmm/main/logout_btn.gif' />" alt="로그아웃" /></a></li>
	            </ul>
	        </div>
	    </div>
	</div>
    ...
    <div id="gnb"> 
        <div class="hdInner">
            <div id="top_logo"><a href="<c:url value='/sym/mnu/mpm/EgovMainMenuHome.do' />" target=_top><img style="margin-top:18px;" src="<c:url value='/images/egovframework/com/cmm/main/logo_01.gif' />" alt="egovframe" /></a></div>
        </div>
    </div>
    <!-- end gnb -->
    ...
    <div id="new_topnavi">
        <ul class="hdInner">
			<%-- <li class="home"><a href="<c:url value='/sym/mnu/mpm/EgovMainMenuHome.do' />" target="_top">HOME</a></li> --%>
			<c:forEach var="result" items="${list_headmenu}" varStatus="status">
			   <li class="menu"><a href="javascript:fn_main_headPageMove('<c:out value="${result.menuNo}"/>','<c:out value="${result.chkURL}"/>')"><c:out value="${result.menuNm}"/></a></li>
			</c:forEach>
        </ul>
    </div>
    <!-- end new_topnavi -->
