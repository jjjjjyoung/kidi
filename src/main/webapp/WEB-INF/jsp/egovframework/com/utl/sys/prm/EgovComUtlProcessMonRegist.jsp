...
<c:set var="pageTitle">
	<spring:message code="comUtlSysPrm.comUtlProcessMonRegist.title" />
</c:set>
<!DOCTYPE html>
...
<body onLoad="fn_egov_initl_ProcessMon();">
	...
	<div class="layout-container">
		...
		<form:form commandName="processMonVO" name="processMonVO"
			method="post">
			...
			<div class="wTableFrm">
				...
				<table class="wTable">
					...
					<tr>
						<th><spring:message
								code="comUtlSysPrm.comUtlProcessMon.processName" /> <span
							class="pilsu">*</span></th>
						<!-- 프로세스명  -->
						<td class="left"><form:input onkeyup="cleanQueryTerm()"
								path="processNm" size="30" maxlength="30" /> <form:errors
								path="processNm" /></td>
					</tr>
					<tr>
						<th><spring:message
								code="comUtlSysPrm.comUtlProcessMon.managerName" /> <span
							class="pilsu">*</span></th>
						<!-- 관리자명 -->
						<td class="left"><form:input path="mngrNm" maxlength="60"
								cssStyle="width:128px" /> <form:errors path="mngrNm" /></td>
					</tr>
					<tr>
						<th><spring:message
								code="comUtlSysPrm.comUtlProcessMon.managerEmail" /> <span
							class="pilsu">*</span></th>
						<!-- 관리자이메일 -->
				...
				<div class="btn">
					<input class="s_submit" type="submit"
						...
						onclick="fn_egov_regist_ProcessMon(document.processMonVO); return false;" />
					<input class="s_submit" type="submit"
						value='<spring:message code="button.list" />'
						onclick="fn_egov_list_ProcessMon(); return false;" />
				</div>
