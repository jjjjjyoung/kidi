...
<div class="wTableFrm">
	...
	<tbody>
		...
		<c:set var="title">게시판관리자</c:set>
		<tr>
			<th><label for="bbsAdmin">${title} </th>
			<td class="left">
			    <form:input path="bbsAdmin" title="${title} ${inputTxt}" size="50" maxlength="70" />
   				<div><form:errors path="bbsAdmin" cssClass="error" /></div>     
			</td>
		</tr>
