                        ...
                        <table class="wTable" summary="게시글의 내역에 대한 목록을 출력합니다." cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="left">
                                        <!-- <input id="nttCn" name="nttCn" title="내용 입력" type="text" value="" size="70" maxlength="200"> -->
                                        <textarea id="nttCn" name="nttCn" title="내용 입력" style="height:300px;margin:5px 0;resize: vertical;"></textarea>
...
function fn_egov_regist_article() {
	...
	*/
	if(validateForm.file_0.value == ''){
		alert("Please register the attached file.");
		return false;
	}
