...
<!-- 댓글 내용  -->
	...
	<h3 class="re_tit">${replyTitle} <c:out value="${resultCnt}"/></h3>
	<div class="reply">
		<ul>
	...
	<form:form commandName="articleCommentVO" action="${pageContext.request.contextPath}/cop/cmt/insertArticleComment.do" method="post" onSubmit="fn_egov_insert_commentList(); return false;" style="clear:both;">
	<div class="wTableFrm" >
