                    ...
                    <div class="wTableFrm">
                        ...
                        <table class="wTable" summary="게시글의 내역에 대한 목록을 출력합니다." cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                            	...
                            	<c:if test="${articleVO.bbsId == 'BBSMSTR_000000000201'}">
		                           	<tr>
										...
										<td class="left">
											<select name="ctype" id="ctype" title="E-BOOK종류" value="" style="margin-top: -5px;">
													...
													<option value="a" <c:if test="${articleVO.ctype == 'a'}">selected</c:if>>연구보고서</option>
													<option value="b" <c:if test="${articleVO.ctype == 'b'}">selected</c:if>>종합간행물</option>
													<option value="c" <c:if test="${articleVO.ctype == 'c'}">selected</c:if>>정책브리프</option>
											</select>
										</td>
									</tr>
								</c:if>
                                ...
                                <tr>
                                   ...
                                   <td class="left">
                                       <input id="address" name="address" title="링크 입력" type="text" value="${articleVO.address }" size="70" maxlength="150">
                                   </td>
                               </tr>
