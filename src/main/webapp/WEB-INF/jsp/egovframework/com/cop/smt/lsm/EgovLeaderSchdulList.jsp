...
<body>
	<div class="layout-container">
		...
		<h1 class="tit01">
			<spring:message code="comCopSmtLsm.leaderSchdulList.title" />
		</h1>
		<!-- 간부일정 목록 -->
		...
		<div id="content" style="width: 712px">
			...
			<div class="tab01 mb10">
				<ul>
					<li><a
						href="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulMonthList.do' />"
						target="SchdulView" onclick="fnTabMenuSelect(0);"><spring:message
								code="comCopSmtLsm.leaderSchdulList.title.selectLeaderSchdulMonthList" /></a></li>
					<!-- 월별일정보기 -->
					<li><a
						href="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulWeekList.do' />"
						target="SchdulView" onclick="fnTabMenuSelect(1);"><spring:message
								code="comCopSmtLsm.leaderSchdulList.title.selectLeaderSchdulWeekList" /></a></li>
					<!-- 주간별일정보기 -->
					<li><a
						href="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulDailyList.do' />"
						target="SchdulView" onclick="fnTabMenuSelect(2);"><spring:message
								code="comCopSmtLsm.leaderSchdulList.title.selectLeaderSchdulDailyList" /></a></li>
					<!-- 일별일정보기 -->
				</ul>
			</div>
	...
	<tr> 
	 ...
	 --%>
			...
			<!-- iframe -->
			<iframe id="SchdulView" name="SchdulView"
				src="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulMonthList.do' />"
				width="100%" height="670px" frameborder="0" scrolling="no"
				marginwidth="0" marginheight="0" title="월별/주별/일별 간부일정목록"> </iframe>
			<!-- //iframe -->
			<form name="leaderSchdulVO" id="leaderSchdulVO"
				action="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulList.do' />"
				method="post" target="SchdulView">
				<input type="hidden" name="year" id="year"
					value="${leaderSchdulVO.year}"> <input type="hidden"
					name="month" id="month" value="${leaderSchdulVO.month}"> <input
					type="hidden" name="week" id="week" value="${leaderSchdulVO.week}">
				<input type="hidden" name="day" id="day"
					value="${leaderSchdulVO.day}"> <input type="hidden"
					name="schdulId" id="schdulId" value=""> <input
					type="hidden" name="schdulDe" id="schdulDe" value=""> <input
					type="hidden" name="schdulBgnDe" id="schdulBgnDe" value="">
				<input type="hidden" name="schdulEndDe" id="schdulEndDe" value="">
				<input type="hidden" name="searchMode" id="searchMode"
					value="${leaderSchdulVO.searchMode}"> <input type="submit"
					value="" style="border: 0px solid; height: 0px; width: 0px;">
			</form>
		</div>
