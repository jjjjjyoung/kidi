...
<div class="layout-container container2">
...
<div class="board">
	...
	<!-- 목록영역 -->
	<table class="datatables-demo table table-striped table-bordered dataTable no-footer" summary="<spring:message code="common.summary.list" arguments="${pageTitle}"/>" style="border-bottom: 2px solid #333;">
	<caption style="text-indent:-9999%">${pageTitle} <spring:message code="title.list" /></caption>
	<colgroup>
		<col style="width: 9%;">
		<col style="width: 40%;">
		<col style="width: 13%;">
