...
<div class="board">
		...
		<table class="datatables-demo table table-striped table-bordered dataTable no-footer" summary="<spring:message code="comCopSymEms.list.summary" arguments="${pageTitle}" />">
