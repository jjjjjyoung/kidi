	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<input style="background:#75c4e6;" class="s_btn" type="button" value="<spring:message code="input.input" />" title="<spring:message code="input.input" />" onclick="fn_egov_addNcrdInf();" /><!-- 등록 -->
			</li>
		</ul>
	</div>
