...
<style>
.search_box ul li input#searchEndDate {
	margin-left:5px;
}
</style>
</head>
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<select style="margin-right:0.5rem;" name=sttus class="select" title="<spring:message code="comSymBat.batchResultList.searchCondition"/>"><!-- 검색조건구분 -->
