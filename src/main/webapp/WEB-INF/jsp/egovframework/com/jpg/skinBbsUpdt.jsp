                        ...
                        <table class="wTable" summary="게시글의 내역에 대한 목록을 출력합니다." cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr class="text">
                                 ...
                                 -->
                                <c:if test="${articleVO.bbsId != 'BBSMSTR_000000000122' && articleVO.bbsId != 'BBSMSTR_000000000191'}">
	                                <tr>
                                ...
                                <c:if test="${articleVO.bbsId != 'BBSMSTR_000000000041' && articleVO.bbsId != 'BBSMSTR_000000000122' && articleVO.bbsId != 'BBSMSTR_000000000191'}">
	                                <tr>
                                ...
                                <c:if test="${articleVO.bbsId != 'BBSMSTR_000000000042' && articleVO.bbsId != 'BBSMSTR_000000000043' && articleVO.bbsId != 'BBSMSTR_000000000044' && articleVO.bbsId != 'BBSMSTR_000000000045' && articleVO.bbsId != 'BBSMSTR_000000000061' && articleVO.bbsId != 'BBSMSTR_000000000122' && articleVO.bbsId != 'BBSMSTR_000000000191'}">
	                                <tr>
                                ...
                                <c:if test="${boardMasterVO.fileAtchPosblAt == 'Y'}">
									...
									<c:choose>
										<c:when test="${articleVO.bbsId == 'BBSMSTR_000000000191'}">
											<c:set var="title"><spring:message code="comCopBbs.articleVO.updt.atchFileAdd"/>(썸네일)</c:set>
												<tr>
