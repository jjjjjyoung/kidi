		        ...
		        <div class="inner">
		            <div>
						<div class="left">
		                	...
		                	<div style="margin-top:20px;white-space: pre-line;">${result.nttCn}</div>
		                </div>
		                <div class="right">
		                    <dl>
	       		...
	       		<div class="btn">
		       		<span class="btn_b" style="float:right;">
						...
						<a style="float:none;position: inherit;" href="<c:url value='/cop/bbs/deleteArticle.do' />?nttId=${result.nttId}&bbsId=${boardMasterVO.bbsId}&lang=en"  title="<spring:message code="button.delete" />  <spring:message code="input.button" />"><spring:message code="button.delete" /></a>
						</c:if>
					</span>
				</div>
