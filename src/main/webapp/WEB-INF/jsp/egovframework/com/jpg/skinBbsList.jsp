...
<div id="subWrap"
	...
	<div id="container">
		...
		<div class="contentWrap">
			...
			<c:if test="${meCode == '20' || meCode == '2040'}">
				<div>
					<ul class="tab_btn02">
												...
												<c:otherwise>
													<td class="articleSub"
														...
														<c:import url="/cmm/fms/selectFileInfs_n.do" charEncoding="utf-8">
															...
															<c:param name="param_atchNm" value="${resultInfo.nttSj}" />
														</c:import>
															
														</c:if>
														<c:if test="${boardMasterVO.bbsId != 'BBSMSTR_000000000201' }">
															<input type="button" class="goBtn" value='<c:out value="${resultInfo.nttSj }" escapeXml = "false" />' style="background: #fff" />
