...
<div id="subWrap" class="sub0<c:out value='${sClass}'/> ntc">
...
<!--                                 <tr class="text">
                                ...
                                <c:if test="${articleVO.bbsId == 'BBSMSTR_000000000122' }">
                                <tr>
                                    <th><label for="nttSSj">부제목 </label></th>
                                    <td class="left">
                                        <input id="nttSSj" name="nttSSj" title="제목 입력" type="text" value="" size="70" maxlength="70">
                                    </td>
                                </tr>
                                </c:if>
		                   			...
		                   			<tr class="text">
	                                    ...
	                                    <td class="nopd" colspan="3">
	                                        <textarea class="ckeditor txaClass2" id="nttCn" name="nttCn" rows="20" cols="300" placeholder="내용을 입력하세요." required>
												<c:out value="${articleVO.nttCn }" escapeXml="true"/>
											</textarea>
	                                    </td>
	                                    </tr>  
									</c:otherwise>
                                ...
                                <c:if test="${boardMasterVO.fileAtchPosblAt == 'Y'}">
	                                ...
	                                <tr>
	                                	<c:choose>
											<c:when test="${articleVO.bbsId == 'BBSMSTR_000000000191' || articleVO.bbsId == 'BBSMSTR_000000000122'}">
												<th><label for="file_1">첨부파일 (썸네일 이미지)</label> </th>
			                                    <td class="nopd" colspan="3">
