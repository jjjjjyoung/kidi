                    ...
                    <div class="wTableFrm">
                        ...
                        <table class="wTable" summary="게시글의 내역에 대한 목록을 출력합니다." cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                	<c:set var="subtitle"><spring:message code="comCopBbs.articleVO.updt.nttSSj"/></c:set> 
                                    <th><label for="nttSSj">${subtitle }<span class="pilsu">*</span></label></th>
                                    <td class="left">
                                        <input id="nttSSj" name="nttSSj" title="제목 입력" type="text" value="<c:out value='${articleVO.nttSSj}'  escapeXml = "false" />" size="70" maxlength="70">                                        
                                    </td>
                                </tr>                                
                                <c:choose>
                                ...
                                <tr class="text">
                                 ...
                                 -->
                                <c:if test="${articleVO.bbsId != 'BBSMSTR_000000000131' && articleVO.bbsId != 'BBSMSTR_000000000151' && articleVO.bbsId != 'BBSMSTR_000000000152'}">
	                                <tr>
                        ...
                        <input type="hidden" name="returnUrl" value="<c:url value='/cop/bbs/updateArticleView.do?lang=en'/>"/>
...
function fn_egov_regist_article() {
	...
	*/
	...
	if(CKEDITOR.instances.nttCn.getData() =='' 
        || CKEDITOR.instances.nttCn.getData().length ==0){
		alert("insert Content.");
	    $("#cntnt").focus();
	    return false;
	}
