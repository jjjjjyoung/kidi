						...
						<form method="post" class="schForm"
							...
							<div class="select_box">
								...
								<select name="searchCnd" title="분류">
									<option value="1" <c:if test = "${articleVO.searchCnd == '1'}">selected</c:if>>title</option>
									<option value="2" <c:if test = "${articleVO.searchCnd == '2'}">selected</c:if>>content</option>
									<option value="3" <c:if test = "${articleVO.searchCnd == '3'}">selected</c:if>>title+content</option>
								</select>
							</div>
					...
					<div class="ntc_table">
						...
						<table>
							...
							<tr style="line-height: 58px; border-bottom: 1px solid #333;">
								...
								<th style="width: 10%;" class="disap_68">Writer</th>
							...
							<c:forEach items="${noticeList}" var="noticeInfo"
								...
								<tr class="bo_notice">
									...
									<td class="articleSub"
										...
										<input type="button" class="goBtn" value='<c:out value="${noticeInfo.nttSj}" escapeXml = "false"/>'	style="background: #f8f8f8" />
							...
							<c:forEach items="${resultList}" var="resultInfo"
								...
								<tr>
									...
									<c:choose>
										...
										<c:otherwise>
											<td class="articleSub"
												...
												<p><c:out value="${resultInfo.nttSSj}" escapeXml = "false"/></p>
											</td>
										</c:otherwise>
									</c:choose>
									...
									<td class="td_datetime"><c:out
											value='${resultInfo.frstRegistPnttm}' /></td>
