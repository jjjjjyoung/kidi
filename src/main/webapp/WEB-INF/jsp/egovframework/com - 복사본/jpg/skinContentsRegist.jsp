...
<script type="text/javaScript" language="javascript">
	...
	function fn_egov_save_IndvdlInfoPolicy() {
		...
		varFrom.onsubmit();
		if (confirm("저장하시겠습니까 ?")) {
			varFrom.action = "<c:url value='/contentsRegist.do' />";
...
<div class="layout-container">
	...
	<form id="htmlEditorVO" name="htmlEditorVO" action="/contentsRegist.do" method="post" enctype="multipart/form-data">
		...
		<div class="wTableFrm">
			...
			<table class="wTable">
				...
				<tr>
					...
					<td class="left">
						<input type="text" id="ctsId" name="ctsId"/>
					</td>
				</tr>
				<tr>
					<th>
						...
						<span class="pilsu">*</span></th>
					<td class="left">
						<input type="text" id="ctsNm" name="ctsNm"/>
					</td>
				</tr>
				<tr>
					<th>
						...
						<span class="pilsu">*</span></th>
					<td class="left">
						<input type="text" id="ctsTi" name="ctsTi"/>
					</td>
				</tr>
				<tr style="width:100%!important;clear:both;">
					...
					<td class="left" style="width:100%!important;">
						<textarea class="ckeditor txaClass2" id="ctsCn" name="ctsCn" rows="10" cols="14" placeholder="내용을 입력하세요."></textarea>
					</td>
				</tr>
			</table>
