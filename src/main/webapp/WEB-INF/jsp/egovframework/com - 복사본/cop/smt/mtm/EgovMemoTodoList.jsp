	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a style="background:#6bc3b0!important;" href="<c:url value='/cop/smt/mtm/selectMemoTodoListToday.do'/>" onclick="fn_egov_select_memotoday(); return false;" title="<spring:message code="comCopSmtMtm.memoTodoList.toDoListToday"/>"><spring:message code="comCopSmtMtm.memoTodoList.toDoListToday"/></a></span><!-- 오늘의 할일 -->
				<input class="s_btn" style="margin-left:0.8rem;" type="submit" value="<spring:message code="title.inquire"/>" title="<spring:message code="title.inquire"/>" onclick="fn_egov_select_memotodo('1'); return false;" /><!-- 조회 -->
			  ...
			  <tr>
			    ...
			    <td>
			     <form name="memoReprtVO" method="post" action="<c:url value='/cop/smt/mtm/selectMemoTodo.do'/>">
			    	...
			    	<input style="margin-left:0.5rem!important;" name="searchEndDe" type="hidden" value="<c:out value='${searchVO.searchEndDe}'/>">
