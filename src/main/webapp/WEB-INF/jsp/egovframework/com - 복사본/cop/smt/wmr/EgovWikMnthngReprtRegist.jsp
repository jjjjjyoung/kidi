	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<form:input path="reprtDe" size="10" maxlength="10" title="${reprtDate}" cssStyle="width:100px"/><!-- 보고일자 -->
		...
		<tr>
			...
			<td class="left">
			    ...
			    <form:input path="reprtBgnDe" size="10" maxlength="10" title="${reprtBgnDate}" cssStyle="width:100px"/><!-- 해당 시작일자 -->
				<form:input path="reprtEndDe" size="10" maxlength="10" title="${reprtEndDate}" cssStyle="width:100px"/><!-- 해당 종료일자 -->
