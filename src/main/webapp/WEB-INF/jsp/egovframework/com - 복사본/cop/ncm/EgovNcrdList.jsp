...
<div class="board">
	...
	<table class="datatables-demo table table-striped table-bordered dataTable no-footer" summary="<spring:message code="comCopNcm.ncrdList.multiList" />"><!-- 번호,이름,회사명,부서명,등록일자,사용등록   목록입니다. -->
