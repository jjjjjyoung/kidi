<%
  ...
  * @Description : EgovBBSMasterList íë©´
  ...
  * @ 2018.10.15   ìµëì             íì¤íë ììí¬ V3.8 ê°ì 
...
<style>
    ...
    .search_box span.btn_b { padding: 0; background: none;}
...
<!--                 <form method="post" class="schForm">
        ...
        <div class="page_title">프로그램 등록</div>
