...
<h1><spring:message code="comCopSmtMrm.memoReprtRegist.title"/></h1>
...
<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <form:input path="reprtDe" maxlength="10" size="10" readonly="true" title="보고일자" cssStyle="width:100px;"/>
		...
		<tr>
			...
			<td class="left">
			    <form:textarea path="reprtCn" cols="95" rows="10" title="보고내용"/> 
