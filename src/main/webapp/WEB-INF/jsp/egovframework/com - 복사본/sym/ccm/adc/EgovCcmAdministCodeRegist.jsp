...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <form:input  path="administZoneCode" maxlength="10" title="행정구역코드" cssStyle="width:80px"/>
		...
		<tr>
			...
			<td class="left">
				...
				<input name="vcreatDe" maxlength="10" readonly="readonly" onclick="fn_egov_NormalCalendar(document.administCode, document.administCode.creatDe, document.administCode.vcreatDe);" title="생성일자(새창)" style="width:80px" />
		...
		<tr>
			...
			<td class="left">
			    <input name="vablDe" maxlength="10" readonly="readonly" onclick="fn_egov_NormalCalendar(document.administCode, document.administCode.ablDe, document.administCode.vablDe);" title="폐기일자(새창)" style="width:80px"/>
