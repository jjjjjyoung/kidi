...
#ntwrk>.wTable>tbody>tr>th,
#ntwrk>.wTable>tbody>tr>td{
	width:100%;
}
label {
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <label for="ntwrkIp"><input name="ntwrkIp" id="ntwrkIp" type="text" maxLength="23"  /><form:errors path="ntwrkIp" /></label>
			</td>
		</tr>
		<tr>
			<th><spring:message code="comSymSymNwk.ntwrkRegist.gtwy"/> <span class="pilsu">*</span></th><!-- 게이트웨이 -->
			<td class="left">
			    <label for="gtwy"><input name="gtwy" id="gtwy" type="text" maxLength="23"  /><form:errors path="gtwy" /></label>
			</td>
		</tr>
		<tr>
			<th><spring:message code="comSymSymNwk.ntwrkRegist.subnet"/> <span class="pilsu">*</span></th><!-- 서브넷 -->
			<td class="left">
			    <label for="subnet"><input name="subnet" id="subnet" type="text" maxLength="23"  /><form:errors path="subnet" /></label>
			</td>
		</tr>
		<tr>
			<th><spring:message code="comSymSymNwk.ntwrkRegist.domnServer"/> <span class="pilsu">*</span></th><!-- DNS -->
			<td class="left">
			    <label for="domnServer"><input name="domnServer" id="domnServer" type="text" maxLength="23"  /><form:errors path="domnServer" /></label>
			</td>
		</tr>
		<tr>
