...
<table class="datatables-demo table table-striped table-bordered dataTable no-footer" summary="<spring:message code="comSymCcmZip.zipVO.summaryList"/>"> <!-- 우편번호와 주소를 출력하는 우편번호 목록 테이블이다. -->
