	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a style="background:#6bc3b0;" href="<c:url value='/sym/mnu/bmm/openPopup.do?requestUrl=/sym/mnu/bmm/previewBkmkInf.do&amp;width=850&amp;height=360'/>" onclick="fn_egov_preview_bkmkInfs(); return false;" title="<spring:message code="comSymMnuBmm.bkmkMenuManageList.newWindow" />"><spring:message code="comSymMnuBmm.bkmkMenuManageList.preview" /></a></span><!-- 새창 --><!-- 미리보기 -->
				<span class="btn_b"><a style="margin-left:10px;background:#ec9e9e;" href="<c:url value= 'fn_egov_deleteBkmkInf()'/>" onclick="fn_egov_deleteBkmkInf(); return false;" title="<spring:message code="title.delete" />"><spring:message code="title.delete" /></a></span><!-- 삭제 -->
