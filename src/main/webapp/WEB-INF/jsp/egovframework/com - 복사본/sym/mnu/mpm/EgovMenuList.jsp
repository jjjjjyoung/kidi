...
function initlMenuList() {
	...
	document.menuManageVO.linkUrl.value="";
 ...
 ******************************************************** */
 function choiceNodes(nodeNum) {
		...
		document.menuManageVO.linkUrl.value = nodeValues[12];		
...
<style>
	...
	.search_box .btn_b:nth-child(3) a {
		margin-left: 0;
	}
...
table.wTableFrm table, table.wTable {
    border-collapse: collapse !important;
    width: 100%;
}
...
table.wTableFrm table th, table.wTableFrm table td, table.wTable th, table.wTable td {
...
<table>
  ...
  <tr>
   <td style="vertical-align:top">
	...
	<input type="hidden" name="tmp_menuNmVal" value="${result.menuNo}|${result.upperMenuId}|${result.menuNm}|${result.progrmFileNm}|${result.menuNo}|${result.menuOrdr}|${result.menuNm}|${result.upperMenuId}|${result.menuDc}|${result.relateImagePath}|${result.relateImageNm}|${result.progrmFileNm}|${result.linkUrl}">
	</c:forEach>
   ...
   <td style="vertical-align:top">
		...
		<table class="wTable" >
		  ...
		  <tr>
			...
			<tr>
			<th><label for="linkUrl">링크 경로</label><span class="pilsu">*</span>	</th>
			<td class="left">
				<input class="form-control" name="linkUrl" id="linkUrl" type="text" value="" title="관련이미지경로">
			</td>
			</tr>
			<!--
		  <tr>
		    <th><spring:message code="comSymMnuMpm.menuList.progrmFileNm" /> <span class="pilsu">*</span></th>
		    <td class="left">
		  ...
		  <tr>
		    <th><spring:message code="comSymMnuMpm.menuList.relateImageNm" /> <span class="pilsu">*</span></th>
		    <td width="70%" nowrap>
		      
		    </td>
		  </tr>
		  <tr>
		    <th><spring:message code="comSymMnuMpm.menuList.relateImagePath" /> <span class="pilsu">*</span></th>
		    <td>
		      
		    </td>
		  </tr>
		   -->
		   <input name="progrmFileNm" type="hidden" size="30" value="dir"  maxlength="60" title="<spring:message code="comSymMnuMpm.menuList.progrmFileNm" />" >
		   <input name="relateImageNm" type="hidden" size="30" value="/"  maxlength="30" title="<spring:message code="comSymMnuMpm.menuList.relateImageNm" />" >
		   <input name="relateImagePath" type="hidden" size="30" value="/"  maxlength="60" title="<spring:message code="comSymMnuMpm.menuList.relateImagePath" />" >
		  <tr>
