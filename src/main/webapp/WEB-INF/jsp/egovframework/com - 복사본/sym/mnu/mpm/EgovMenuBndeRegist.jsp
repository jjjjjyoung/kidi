...
<body>
	...
	<div class="layout-container">
		...
		<div class="wTableFrm">
			...
			<form name="menuManageRegistForm"
				action="<c:url value='/sym/mnu/mpm/EgovMenuBndeRegist.do'/>"
				...
				<table class="wTable">
					...
					<tr>
						<th><spring:message code="comSymMnuMpm.menuBndeRegist.menuNo" />
							<span class="pilsu">*</span></th>
						<td class="left"><input type="file" name="file" size="40"
							title="<spring:message code='title.attachedFileSelect'/>">
						</td>
					</tr>
				</table>
				...
				<div class="btn">
					<input class="s_submit" type="submit"
						value="<spring:message code="button.bulkUpload" />"
