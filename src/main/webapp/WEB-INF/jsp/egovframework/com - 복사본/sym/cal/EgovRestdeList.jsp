...
<body>
	...
	<div class="layout-container">
		...
		<div class="board">
			...
			<form name="listForm"
				action="<c:url value='/sym/cal/EgovRestdeList.do'/>" method="post">
				<div class="search_box"
					...
					<ul>
						<li><select name="searchCondition" class="select" title=""
							...
							onkeypress="press();" /> <span class="btn_b"><a
								href="#noscript"
								onclick="fn_egov_search_Restde(); return false;"
								title="<spring:message code="button.inquire" />"><spring:message
										code="button.inquire" /></a></span> <input class="s_btn" type="submit"
							value="<spring:message code="button.create" />"
							title="<spring:message code="button.create" />"
							onclick="fn_egov_regist_Restde(); return false;" /></li>
					</ul>
				</div>
				...
				<table
					...
					<thead>
						<tr>
							<th scope="col"><spring:message code="sym.cal.column1" /></th>
							<!-- 순번 -->
							<th scope="col"><spring:message code="sym.cal.column2" /></th>
							<!-- 휴일일자 -->
							<th scope="col"><spring:message code="sym.cal.column3" /></th>
							<!-- 휴일명 -->
							<th scope="col"><spring:message code="sym.cal.column4" /></th>
							<!-- 휴일구분 -->
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${resultList}" var="resultInfo"
							...
							<tr style="cursor: pointer; cursor: hand;"
								onclick="fn_egov_detail_Restde('${resultInfo.restdeNo}');">
								<td><c:out
			...
			<form name="Form" method="post">
				<input type="hidden" name="restdeNo"> <input type="submit"
