...
<form name="QustnrTmplatManageForm" id="QustnrTmplatManageForm" action="<c:url value='/uss/olp/qqm/EgovQustnrQestnManageModify.do'/>" method="post">
	...
	<div style="visibility:visible;display:none;"><input name="iptSubmit" type="submit" value="<spring:message code='comUssOlpQqm.title.submit'/>" title="<spring:message code='comUssOlpQqm.title.submit'/>"></div><!-- value="전송" title="전송" -->
