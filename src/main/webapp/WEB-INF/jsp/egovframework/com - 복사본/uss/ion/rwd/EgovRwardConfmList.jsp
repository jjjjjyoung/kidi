		...
		<ul>
			<li>
				...
				<input name="searchFromDate"  id="searchFromDate" type="text" readonly="readonly"  maxlength="10" value="${fromNow}" title="<spring:message code="comUssIonRwd.common.searchFromDate"/>" style="width:68px; "  /><!-- 포상 시작일자 -->
				 ~
				<input name="searchToDate" id="searchToDate" type="text" readonly="readonly"  maxlength="10" value="${toNow}" title="<spring:message code="comUssIonRwd.common.searchToDate"/>" style="width:68px; margin-left:5px; " /><!-- 포상 종료일자 -->
