...
<div style="visibility:visible;display:none;"><input name="iptSubmit" type="submit" value="<spring:message code="comUssIonCtn.ctsnnManageDetail.submit"/>" title="<spring:message code="comUssIonCtn.ctsnnManageDetail.submit"/>"></div><!-- 전송 -->
