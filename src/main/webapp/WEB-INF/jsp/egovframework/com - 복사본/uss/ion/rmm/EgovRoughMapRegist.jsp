	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<span class="btn_s"><input type="submit" value="<spring:message code="button.search" />" onclick="fn_Address_Search(); return false;" style="padding:6px 12px 6px 12px; background-color:#6bc3b0; border:0; color:#f1f8ee; font-size:11px;"></span>
			</td>
		</tr>
		<tr>
