...
<style type="text/css">
	h1 {font-size:12px;}
	caption {visibility:visible; font-size:0; height:0; margin:0; padding:0; line-height:0;}
</style>
...
<noscript class="noScriptTitle"><spring:message code="common.noScriptTitle.msg" /></noscript>
	<div class="wTableFrm" style="width:625px; ">
		...
		<form name="imageForm" method="post">
			<div style="visibility:visible;display:none;"><input name="iptSubmit" type="submit" value="<spring:message code="comUssIonMtg.mtgPlaceResveDetail.submit" />" title="<spring:message code="comUssIonMtg.mtgPlaceResveDetail.submit" />"></div>
		</form>
