...
<form name="QustnrRespondManageForm" id="QustnrRespondManageForm" action="<c:url value='/uss/olp/qrm/EgovQustnrRespondManageModify.do'/>" method="post">
	...
	<div style="visibility:visible;display:none;"><input name="iptSubmit" type="submit" value="<spring:message code='comUssOlpQrm.title.submit'/>" title="<spring:message code='comUssOlpQrm.title.submit'/>"></div><!-- value="전송" title="전송" -->
