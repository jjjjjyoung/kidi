...
<style>
    h3 { padding-left: 10px; font-size: 1.385rem !important;}
</style>
		...
		<ul>
			...
			<li style="border:0">
				...
				<input type="hidden" name="cal_url" id="cal_url" value="<c:url value='/sym/cal/EgovNormalCalPopup.do'/>" >
                  ...
                  <input type="text" name="pmTyToDate" size="10" tabindex="2" title="<spring:message code="comStsDst.dtaUseStats.toDate" />" id="pmTyToDate" value="${dtaUseStatsVO.pmToDate}" style="margin-left: 10px;"/> <!-- 종료일자 -->
				
				<input style="margin-left: 10px;" class="s_btn" type="submit" value="<spring:message code="button.inquire" />" title="<spring:message code="button.inquire" />" onclick="fncSelectDtaUseStatsList('1'); return false;" />
			</li>
		</ul>
	</div>
