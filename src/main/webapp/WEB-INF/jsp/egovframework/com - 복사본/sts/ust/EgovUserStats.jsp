...
<style>
 ...
 div.board h1, div.calendar h2, .layout-container h2, .layout-container h1,	.wTableFrm h2 { font-size: 1.385rem !important; border-bottom: 1px solid rgba(0, 0, 0, .125); padding-left: 10px;}
 h3 { font-size: 1.308rem; padding-left: 10px;}
</style>
</head>
