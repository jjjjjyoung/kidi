...
function fncAuthorUpdate(form) {
	if(confirm("<spring:message code="common.update.msg" />")){	//ìì íìê² ìµëê¹?
...
<div class="layout-container">
	...
	<!-- íì´í -->
	<h2>${pageTitle} <spring:message code="title.update" /></h2><!-- ê¶íê´ë¦¬ ìì  -->
...
<div class="wTableFrm">
	...
	<!-- íë¨ ë²í¼ -->
	<div class="btn">
		<input type="submit" class="s_submit" value="<spring:message code="button.update" />" title="<spring:message code="button.update" /> <spring:message code="input.button" />" /><!-- ìì  -->
