...
<style>
.layout-container form, div.board, .layout-container { width: 100% !important;}
.layout-container form { padding: 0 !important; border:0;}
</style>
</head>
<body>
...
<div class="layout-container">
	...
	<form:form name="listForm" action="${pageContext.request.contextPath}/sec/ram/EgovAuthorRoleList.do" method="post">
		...
		<!-- 목록영역 -->
		<table class="board_list datatables-demo table table-striped table-bordered dataTable no-footer" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
