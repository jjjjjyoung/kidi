    ...
    var s = function (t) {
                ...
                p = function () {
                    function t(e) {
                        ...
                        if (function (t, e) {
                            ...
                            this.settings = {}, this.settings.cssPath = s, this.settings.themesPath = n, this.settings.cssFilenamePattern = i || u, this.settings.navbarBgs = l || t.NAVBAR_BGS, this.settings.defaultNavbarBg = c || v, this.settings.sidenavBgs = r || t.SIDENAV_BGS, this.settings.defaultSidenavBg = o || f, this.settings.footerBgs = d || t.FOOTER_BGS, this.settings.defaultFooterBg = p || m, this.settings.availableThemes = b || t.AVAILABLE_THEMES, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== y ? y : h), this.settings.controls = a || g, this.settings.lang = k || "en", this.pathResolver = _ || function (t) {
                                return t
                    ...
                    return e = t, (s = [{
                        ...
                        key: "setTheme",
                        value: function (t) {
                            var e, s, n, i = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                                a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null;
                            if (this._hasControls("themes")) {
                                var r = this._getThemeByName(t);
                                if (r) {
                                    this.settings.theme = r, i && this._setSetting("Theme", t);
                                    var o = this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace("%name%", t + (this.settings.material ? "-material" : "")));
                                    this._loadStylesheets((e = {}, s = o, n = document.querySelector(".theme-settings-theme-css"), s in e ? Object.defineProperty(e, s, {
                                        value: n,
                                        enumerable: !0,
                                        configurable: !0,
                                        writable: !0
                                    }) : e[s] = n, e), a || function () {}), i && this.settings.onSettingsChange.call(this, this.settings)
                                }
                            }
                        }
                    }, {
                        ...
                        value: function (e) {
                            ...
                            if (e !== this.settings.lang || n) {
                                ...
                                for (var a = i.themes || {}, r = this.container.querySelectorAll(".theme-settings-theme-item") || [], o = 0, l = r.length; o < l; o++) {
                        ...
                        key: "_getThemeByName",
                        value: function (t) {
                            for (var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], s = this.settings.availableThemes, n = 0, i = s.length; n < i; n++)
                                if (s[n].name === t) return s[n];
            ...
            t.exports = function (t) {
                ...
                return e.toString = function () {
                    return this.map(function (e) {
                        var s = function (t, e) {
                            ...
                            if (e && "function" == typeof btoa) {
                                var a = (s = i, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(s)))) + " */"),
                    ...
                    for (i = 0; i < t.length; i++) {
                        var r = t[i];
                        null != r[0] && n[r[0]] || (s && !r[2] ? r[2] = s : s && (r[2] = "(" + r[2] + ") and (" + s + ")"), e.push(r))
                    }
                }, e
            }
        },
        40: function (t, e, s) {
            ...
            function u(t, e) {
                for (var s = 0; s < t.length; s++) {
                    ...
                    if (i) {
                        ...
                        for (; r < n.parts.length; r++) i.parts.push(b(n.parts[r], e))
                    } else {
                        for (var o = [], r = 0; r < n.parts.length; r++) o.push(b(n.parts[r], e));
                        a[n.id] = {
                            id: n.id,
                            refs: 1,
                            parts: o
            ...
            function v(t, e) {
                ...
                var n = d[d.length - 1];
                if ("top" === t.insertAt) n ? n.nextSibling ? s.insertBefore(e, n.nextSibling) : s.appendChild(e) : s.insertBefore(e, s.firstChild), d.push(e);
                else if ("bottom" === t.insertAt) s.appendChild(e);
                else {
                    if ("object" != typeof t.insertAt || !t.insertAt.before) throw new Error("[Style Loader]\n\n Invalid value for parameter 'insertAt' ('options.insertAt') found.\n Must be 'top', 'bottom', or Object.\n (https://github.com/webpack-contrib/style-loader#insertat)\n");
                    var i = o(t.insertAt.before, s);
                    s.insertBefore(e, i)
                }
            }
            ...
            function b(t, e) {
                ...
                if (e.singleton) {
                    var r = c++;
                    s = l || (l = m(e)), n = x.bind(null, s, r, !1), i = x.bind(null, s, r, !0)
                    ...
                    return void 0 === t.attrs.type && (t.attrs.type = "text/css"), t.attrs.rel = "stylesheet", p(e, t.attrs), v(t, e), e
                }(e), n = function (t, e, s) {
                    var n = s.css,
                        i = s.sourceMap,
                        a = void 0 === e.convertToAbsoluteUrls && i;
                    (e.convertToAbsoluteUrls || a) && (n = h(n)), i && (n += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(i)))) + " */");
                    var r = new Blob([n], {
                            type: "text/css"
                        }),
                        o = t.href;
