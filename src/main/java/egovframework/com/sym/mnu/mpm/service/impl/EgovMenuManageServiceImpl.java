...
public class EgovMenuManageServiceImpl extends EgovAbstractServiceImpl implements EgovMenuManageService {
	...
	public int beforeDeleteMenuList(MenuManageNewVO MenuManageNewVO) {
		// TODO Auto-generated method stub
		return menuManageDAO.beforeDeleteMenuList(MenuManageNewVO);
	}

	@Override
	public void deleteMenuManageListNew(MenuManageNewVO menuManageNewVO) {
		// TODO Auto-generated method stub
		menuManageDAO.deleteMenuManageListNew(menuManageNewVO);
	}

	@Override
	public List<?> selectMainMenuListNew(MenuManageNewVO menuManageNewVo) {
		// TODO Auto-generated method stub
		return menuManageDAO.selectMainMenuListNew(menuManageNewVo);
	}

	@Override
	public MenuManageNewVO seachMenu(String ctnId) {
		// TODO Auto-generated method stub
		return menuManageDAO.seachMenu(ctnId);
	}

	@Override
	public MenuManageNewVO parentName(String parentCode) {
		// TODO Auto-generated method stub
		return menuManageDAO.parentName(parentCode);
	}
}