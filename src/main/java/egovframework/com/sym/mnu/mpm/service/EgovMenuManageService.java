...
public interface EgovMenuManageService {
	...
	List<?> selectMenuManageListNew(MenuManageNewVO vo);

	MenuManageNewVO selectMenuManageNew(MenuManageNewVO searchVO);

	void updateMenuManageNew(MenuManageNewVO menuManageNewVO);

	MenuManageNewVO getMaxmeCode(MenuManageNewVO menuManageNewVO);

	void insertMenuManageNew(MenuManageNewVO menuManageNewVO);

	int beforeDeleteMenuList(MenuManageNewVO menuManageNewVO);

	void deleteMenuManageListNew(MenuManageNewVO menuManageNewVO);

	List<?> selectMainMenuListNew(MenuManageNewVO menuManageNewVo);

	MenuManageNewVO seachMenu(String ctnId);

	MenuManageNewVO parentName(String parentCode);
