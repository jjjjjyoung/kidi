...
public class MenuManageDAO extends EgovComAbstractDAO{
	...
	public List<?> selectMenuManageListNew(MenuManageNewVO vo) {
		// TODO Auto-generated method stub
		return selectList("menuManageDAO.selectMenuManageListNew",vo);
	}

	public MenuManageNewVO selectMenuManageNew(MenuManageNewVO searchVO) {
		// TODO Auto-generated method stub
		return (MenuManageNewVO)selectOne("menuManageDAO.selectMenuManageNew", searchVO);
	}



	public void updateMenuManageNew(MenuManageNewVO menuManageNewVO) {
		// TODO Auto-generated method stub
		update("menuManageDAO.updateMenuManageNew", menuManageNewVO);
	}

	public MenuManageNewVO getMaxmeCode(MenuManageNewVO menuManageNewVO) {
		
		return selectOne("menuManageDAO.getMaxmeCode", menuManageNewVO);
	}

	public void insertMenuManageNew(MenuManageNewVO menuManageNewVO) {
		// TODO Auto-generated method stub
		insert("menuManageDAO.insertMenuManageNew", menuManageNewVO);
	}

	public int beforeDeleteMenuList(MenuManageNewVO menuManageNewVO) {
		// TODO Auto-generated method stub
		return (Integer)selectOne("menuManageDAO.beforeDeleteMenuList", menuManageNewVO);
	}

	public void deleteMenuManageListNew(MenuManageNewVO menuManageNewVO) {
		// TODO Auto-generated method stub
		delete("menuManageDAO.deleteMenuManageListNew", menuManageNewVO);
	}

	public List<?> selectMainMenuListNew(MenuManageNewVO menuManageNewVo) {
		// TODO Auto-generated method stub
		return selectList("menuManageDAO.selectMainMenuListNew",menuManageNewVo);
	}

	public MenuManageNewVO seachMenu(String ctnId) {
		// TODO Auto-generated method stub
		return selectOne("menuManageDAO.seachMenu", ctnId);
	}

	public MenuManageNewVO parentName(String parentCode) {
		// TODO Auto-generated method stub
		return selectOne("menuManageDAO.parentName", parentCode);
	}
}