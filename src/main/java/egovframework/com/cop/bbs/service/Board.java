...
public class Board implements Serializable {
	...
	/**
	 * nttSSj attribute를 리턴한다.
	 * @return the nttSSj
	 */
	public String getNttSSj() {
		return nttSSj;
	}
	...
	/**
	 * nttSSj attribute 값을 설정한다.
	 * @param nttSSj the nttSSj to set
	 */
	public void setNttSSj(String nttSSj) {
		this.nttSSj = nttSSj;
	}
