...
public class EgovBBSMasterController {
	...
	@RequestMapping("/cop/bbs/selectBBSEduList.do")
	public String selectBBSEduList(@ModelAttribute("searchVO") BoardVO boardVO, MenuManageNewVO searchVO, ModelMap model) throws Exception {
		LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		...
		vo.setBbsId("BBSMSTR_000000000051");
		...
		/* 글쓰기 스킨 분기 */
		/*
		 * if(bdMstr.getBbsTyCode().equals("SKIN01")) { return
		 * "egovframework/com/jpg/skinBbsWrite"; } else
		 * if(bdMstr.getBbsTyCode().equals("SKIN02")) { return
		 * "egovframework/com/cop/bbs/EgovGalleryRegist"; } else
		 * if(bdMstr.getBbsTyCode().equals("SKIN03")) { return
		 * "egovframework/com/cop/bbs/EgovEmployeeRegist"; } else
		 * if(bdMstr.getBbsTyCode().equals("SKIN04")) { return
		 * "egovframework/com/jpg/skinEduWrite"; } else
		 * if(bdMstr.getBbsTyCode().equals("SKIN05")) { return
		 * "egovframework/com/cop/bbs/EgovPerformanceRegist"; } else { return
		 * "forward:/home.do"; }
		 */
		return "egovframework/com/cop/bbs/EgovBBSListPortlet";
	}
