...
public class EgovFileDownloadController {
	...
	public void cvplFileDownload(@RequestParam Map<String, Object> commandMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//if (isAuthenticated) {
			...
			//File uFile = new File("upload/", fvo.getStreFileNm());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/cmm/fms/FileView.do")
	public void cvplFileView(@RequestParam Map<String, Object> commandMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
